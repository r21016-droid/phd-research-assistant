...
Four AI companions over the research lifecycle, sharing one LLM client, one
...
from tabs import idea_critic, lit_explorer, paper_digest, thesis_coach
from utils import MODEL_NAME, get_llm, load_library, save_to_library

# Order here = tab order in the UI. Tab 1, then 2, 3, 4 as numbered in the spec.
TAB_MODULES = [paper_digest, lit_explorer, thesis_coach, idea_critic]
...
def main() -> None:
    ...
    st.title("🎓 Research Assistant")
    st.caption("Four AI companions for reading papers, scouting literature, "
               "planning your thesis, and stress-testing ideas.")
